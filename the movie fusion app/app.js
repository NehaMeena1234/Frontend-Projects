...
mainGridTitle.innnertext="Search Results....";
...
return `<li>${e.name}</li>` ;
  ...
  <!-- movie geners ends here -->  

  <!-- overview contents starts here -->
  <div class="overview">
    <h2>Overview</h2>
    <p>${movie.overview}</p>
  </div>
  <!-- overview contents ends here -->

  <!-- trialor content starts here -->
  <div class="trailer">
    <h2>Trailer</h2>
...
async function addTrendingMoviestoDOM(){
    ...
    const dispalyMovies=data.slice(0,5);
